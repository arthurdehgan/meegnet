...
def stratified_sampling(data, targets, n_samples, subject=None, groups=None):
	...
	assert (subject is None and groups is None) or (subject is not None and groups is not None), (
	...
	for label in unique_labels:
		...
		sampled_indices.extend(class_indices[torch.randperm(len(class_indices))[:n_cls_samples]].tolist())
