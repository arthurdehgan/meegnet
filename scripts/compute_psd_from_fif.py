...
def compute_save_psd(save_path, data_type, clean_type, segment_size, subject, sf, window, overlap):
...
if __name__ == '__main__':
	...
	Parallel(n_jobs=3)(
		delayed(compute_save_psd)(
			SAVE_PATH, data_type, clean_type, 30000, subject, sf=SF, window=WINDOW, overlap=OVERLAP
		)
