...
if __name__ == '__main__':
	...
	parser.add_argument('-f', '--filters', default=8, type=int, help='The size of the first convolution')
	...
	hparams = {'lr': learning_rate, 'weight_decay': 0.0, 'irm_lambda': 1e2, 'irm_penalty_anneal_iters': 500}
	# hparams.update(
