...
import meegnet.networks as networks
import copy
import numpy as np
...
class Algorithm(torch.nn.Module):
	...
	def __init__(self, input_shape, num_classes, num_domains, network, hparams, device):
...
class ERM(Algorithm):
	...
	def __init__(self, input_shape, num_classes, num_domains, network, hparams, device):
		super(ERM, self).__init__(input_shape, num_classes, num_domains, network, hparams, device)
...
class IRM(ERM):
	...
	def __init__(self, input_shape, num_classes, num_domains, network, hparams, device):
		super(IRM, self).__init__(input_shape, num_classes, num_domains, network, hparams, device)
		self.register_buffer('update_count', torch.tensor([0]))
